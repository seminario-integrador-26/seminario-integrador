...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes por defecto del validador. Algunas reglas tienen variantes según
    | el tipo del dato (array, file, numeric, string).
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute apareció en una filtración de datos. Elija otro valor.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'hora' => 'hora',
        'timestamp_video' => 'timestamp del video',
        'hora_inicio' => 'hora de inicio',
        'hora_fin' => 'hora de fin',
        'descripcion' => 'descripción',
        'motivo' => 'motivo',
        'tipo_evento_id' => 'tipo de evento',
        'punto_monitoreo_id' => 'punto de monitoreo',
        'turno_id' => 'turno',
    ],
